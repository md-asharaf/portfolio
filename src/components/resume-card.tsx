            ...
            <div className="flex items-start">
              <div className="flex flex-col items-start space-y-1">
                ...
                <h3 className="inline-flex items-start leading-none text-xs">
                  <Icons.threads className="mr-1 text-muted-foreground dark:text-muted-foreground/70" /> <Link href={href} className="hover:underline" onClick={(e) => e.stopPropagation()} target="_blank" rel="noopener noreferrer">
                    {title}
                  </Link>
                </h3>
              </div>
